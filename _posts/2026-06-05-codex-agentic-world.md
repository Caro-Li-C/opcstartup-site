layout: post title: "工程技术：在智能体优先的世界中利用 Codex" date: 2026-06-05 00:00:00 +0800 category: 原文速递 read_time: 20 views: [待确认] original_url: https://openai.com/index/engineering-codex-agentic-world description: "OpenAI内部实验：三名工程师+Codex，五个月内从零构建百万行代码的完整产品。人类掌舵，智能体执行——软件工程的新范式。" tags: ["OpenAI", "Codex", "智能体编程", "AI工程", "软件工程范式", "Ryan Lopopolo"]
